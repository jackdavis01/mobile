  ...
  void didChangeDependencies() {
    ...
    _fluidAd = FluidAdManagerBannerAd(
      ...
      listener: AdManagerBannerAdListener(
        onAdLoaded: (Ad ad) {
          debugPrint('$_fluidAd loaded.');
        },
        onAdFailedToLoad: (Ad ad, LoadAdError error) {
          debugPrint('$_fluidAd failedToLoad: $error');
          ad.dispose();
        },
        onAdOpened: (Ad ad) => debugPrint('$_fluidAd onAdOpened.'),
        onAdClosed: (Ad ad) => debugPrint('$_fluidAd onAdClosed.'),
      ),
    )..load();
  }
