class GNet {
  ...
  static Uri uriAutoReg = Uri.https("nonet.com", "");

  static Uri uriInsertResults = Uri.https("nonet.com", "");

  static Uri uriAutoRegTracking = Uri.https("nonet.com", "");

  static Uri uriListUserResults = Uri.https("nonet.com", "");
